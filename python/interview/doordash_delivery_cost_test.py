...
class TestSingleDelivery:
    def test_one_hour_delivery(self, solution):
        solution.record_delivery("d1", "2026-03-16 12:00", "2026-03-16 13:00")
        assert solution.total_cost() == 2000

    def test_fractional_hour_delivery(self, solution):
        solution.record_delivery("d1", "2026-03-16 12:00", "2026-03-16 12:30")
        assert solution.total_cost() == 1000

    def test_zero_duration_delivery(self, solution):
        solution.record_delivery("d1", "2026-03-16 12:00", "2026-03-16 12:00")
        assert solution.total_cost() == 0

    def test_overnight_delivery_spans_midnight(self, solution):
        solution.record_delivery("d1", "2026-03-16 23:30", "2026-03-17 00:30")
        assert solution.total_cost() == 2000


class TestMultipleDeliveries:
    def test_same_driver_deliveries_are_summed(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")
        solution.record_delivery("d1", "2026-03-16 11:00", "2026-03-16 11:30")
        assert solution.total_cost() == 3000

    def test_different_drivers_are_summed_together(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")  # 2000
        solution.record_delivery("d2", "2026-03-16 09:00", "2026-03-16 11:00")  # 6000
...
class TestTotalCostBetween:
    def test_delivery_fully_inside_window_is_included(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")
        cost = solution.total_cost_between("2026-03-16 08:00", "2026-03-16 12:00")
        assert cost == 2000

    def test_delivery_fully_outside_window_is_excluded(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")
        cost = solution.total_cost_between("2026-03-16 11:00", "2026-03-16 12:00")
        assert cost == 0
    ...
    def test_delivery_partially_overlapping_window_is_excluded(self, solution):
        ...
        solution.record_delivery("d1", "2026-03-16 07:30", "2026-03-16 08:30")
        cost = solution.total_cost_between("2026-03-16 08:00", "2026-03-16 12:00")
        assert cost == 0

    def test_delivery_exactly_on_window_boundary_is_included(self, solution):
        solution.record_delivery("d1", "2026-03-16 08:00", "2026-03-16 12:00")
        cost = solution.total_cost_between("2026-03-16 08:00", "2026-03-16 12:00")
        assert cost == 8000

    def test_only_deliveries_within_window_are_summed(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")  # inside, 2000
        solution.record_delivery("d2", "2026-03-16 20:00", "2026-03-16 21:00")  # outside
        cost = solution.total_cost_between("2026-03-16 08:00", "2026-03-16 12:00")
        assert cost == 2000
...
class TestTotalCostBetweenSorted:
    ...
    def test_delivery_fully_inside_window_is_included(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")
        cost = solution.total_cost_between_sorted("2026-03-16 08:00", "2026-03-16 12:00")
        assert cost == 2000

    def test_delivery_fully_outside_window_is_excluded(self, solution):
        solution.record_delivery("d1", "2026-03-16 09:00", "2026-03-16 10:00")
        cost = solution.total_cost_between_sorted("2026-03-16 11:00", "2026-03-16 12:00")
        assert cost == 0
    ...
    def test_agrees_with_unsorted_variant_on_sorted_input(self, solution):
        solution.record_delivery("d1", "2026-03-16 07:00", "2026-03-16 07:45")
        solution.record_delivery("d2", "2026-03-16 09:00", "2026-03-16 11:00")
        solution.record_delivery("d1", "2026-03-16 12:00", "2026-03-16 13:15")
        window = ("2026-03-16 08:00", "2026-03-16 12:30")
...
class TestEdgeCases:
    ...
    def test_unrecorded_driver_id_raises_key_error(self, solution):
        solution.record_delivery("unknown", "2026-03-16 09:00", "2026-03-16 10:00")
...
class TestRounding:
    def test_fractional_cent_below_half_rounds_down(self, solution):
        ...
        solution.record_delivery("d1", "2026-03-16 09:00:00", "2026-03-16 09:00:44")
    ...
    def test_fractional_cent_above_half_rounds_up(self, solution):
        ...
        solution.record_delivery("d1", "2026-03-16 09:00:00", "2026-03-16 09:01:01")
    ...
    def test_exact_half_cent_rounds_up(self, solution):
        ...
        solution.record_delivery("d3", "2026-03-16 09:00:00", "2026-03-16 09:30:00")
