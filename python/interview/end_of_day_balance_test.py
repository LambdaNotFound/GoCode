...
@pytest.mark.parametrize("transactions,initial_balance,expected", [
    ...
    (
        [
            ["Alice","Bob","300"],["Charlie","David","400"],["Eve","Frank","200"],
            ["George","Hank","100"],["Alice","Charlie","150"],["David","Eve","300"],
            ["Frank","George","250"],["Bob","Hank","100"],["Charlie","Alice","200"],
            ["Eve","David","150"],
        ],
        [
            ["Alice","1000"],["Bob","600"],["Charlie","500"],["David","700"],["Eve","600"],
            ["Frank","400"],["George","200"],["Hank","100"],["Ivy","300"],["Jack","400"],
        ],
        [750, 800, 50, 950, 550, 350, 350, 300, 300, 400],
    ),
    (
        [
            ["Alice","Bob","150"],["Charlie","Alice","200"],["David","Bob","50"],
            ["Eve","Charlie","100"],["Bob","Eve","300"],["David","Alice","50"],
            ["Alice","Eve","100"],["Charlie","Bob","150"],
        ],
        [["Alice","500"],["Bob","300"],["Charlie","200"],["David","150"],["Eve","250"]],
        [500, 350, -50, 50, 550],
    ),
])
