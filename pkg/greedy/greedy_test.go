...
func Test_videoStitching(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "leetcode_example2_impossible",
			clips: [][]int{{0, 1}, {1, 2}},
			time:  5,
			want:  -1,
		},
		...
		{
			name:  "two_clips_no_overlap",
			clips: [][]int{{0, 5}, {5, 10}},
			time:  10,
			want:  2,
		},
		{
			name:  "gap_in_coverage",
			clips: [][]int{{0, 3}, {5, 10}},
			time:  10,
			want:  -1,
		},
		{
			name:  "no_clip_starts_at_zero",
			clips: [][]int{{1, 5}, {5, 10}},
			time:  10,
			want:  -1,
		},
		...
		{
			name:  "redundant_clips_picks_minimum",
			clips: [][]int{{0, 5}, {0, 5}, {0, 10}},
			time:  10,
			want:  1,
		},
		{
